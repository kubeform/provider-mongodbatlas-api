	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.NetworkV1alpha1().Containers(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.NetworkV1alpha1().Containers(namespace).Watch(context.TODO(), options)
			},
		},
		&networkv1alpha1.Container{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *containerInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&networkv1alpha1.Container{}, f.defaultInformer)
}
