...
type Interface interface {
	...
	// Peerings returns a PeeringInformer.
	Peerings() PeeringInformer
}
...
// Peerings returns a PeeringInformer.
func (v *version) Peerings() PeeringInformer {
	return &peeringInformer{factory: v.factory, namespace: v.namespace, tweakListOptions: v.tweakListOptions}
}
