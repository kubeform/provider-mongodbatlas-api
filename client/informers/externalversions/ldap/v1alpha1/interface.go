...
type Interface interface {
	...
	// Verifies returns a VerifyInformer.
	Verifies() VerifyInformer
}
...
// Verifies returns a VerifyInformer.
func (v *version) Verifies() VerifyInformer {
	return &verifyInformer{factory: v.factory, namespace: v.namespace, tweakListOptions: v.tweakListOptions}
}
