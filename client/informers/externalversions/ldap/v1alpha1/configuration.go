	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.LdapV1alpha1().Configurations(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.LdapV1alpha1().Configurations(namespace).Watch(context.TODO(), options)
			},
		},
		&ldapv1alpha1.Configuration{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *configurationInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&ldapv1alpha1.Configuration{}, f.defaultInformer)
}
