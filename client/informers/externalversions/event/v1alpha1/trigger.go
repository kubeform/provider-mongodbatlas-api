...
import (
	...
	v1alpha1 "kubeform.dev/provider-mongodbatlas-api/client/listers/event/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.EventV1alpha1().Triggers(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.EventV1alpha1().Triggers(namespace).Watch(context.TODO(), options)
			},
		},
		&eventv1alpha1.Trigger{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *triggerInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&eventv1alpha1.Trigger{}, f.defaultInformer)
}
