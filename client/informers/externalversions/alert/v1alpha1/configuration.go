...
import (
	...
	v1alpha1 "kubeform.dev/provider-mongodbatlas-api/client/listers/alert/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AlertV1alpha1().Configurations(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AlertV1alpha1().Configurations(namespace).Watch(context.TODO(), options)
			},
		},
		&alertv1alpha1.Configuration{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *configurationInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&alertv1alpha1.Configuration{}, f.defaultInformer)
}
