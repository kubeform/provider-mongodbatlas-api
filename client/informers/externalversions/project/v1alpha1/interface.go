...
// IpAccessLists returns a IpAccessListInformer.
func (v *version) IpAccessLists() IpAccessListInformer {
	return &ipAccessListInformer{factory: v.factory, namespace: v.namespace, tweakListOptions: v.tweakListOptions}
}
