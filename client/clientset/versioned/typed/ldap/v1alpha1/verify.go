...
// VerifiesGetter has a method to return a VerifyInterface.
...
// verifies implements VerifyInterface
type verifies struct {
	client rest.Interface
	ns     string
}

// newVerifies returns a Verifies
func newVerifies(c *LdapV1alpha1Client, namespace string) *verifies {
	return &verifies{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *verifies) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Verify, err error) {
	result = &v1alpha1.Verify{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("verifies").
		Name(name).
...
func (c *verifies) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.VerifyList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.VerifyList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("verifies").
...
func (c *verifies) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *verifies) Create(ctx context.Context, verify *v1alpha1.Verify, opts v1.CreateOptions) (result *v1alpha1.Verify, err error) {
	result = &v1alpha1.Verify{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("verifies").
...
func (c *verifies) Update(ctx context.Context, verify *v1alpha1.Verify, opts v1.UpdateOptions) (result *v1alpha1.Verify, err error) {
	result = &v1alpha1.Verify{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("verifies").
...
func (c *verifies) UpdateStatus(ctx context.Context, verify *v1alpha1.Verify, opts v1.UpdateOptions) (result *v1alpha1.Verify, err error) {
	result = &v1alpha1.Verify{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("verifies").
...
func (c *verifies) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *verifies) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *verifies) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Verify, err error) {
	result = &v1alpha1.Verify{}
