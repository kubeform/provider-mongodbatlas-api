...
type FakeClusterConfigs struct {
	Fake *FakeGlobalV1alpha1
	ns   string
}

var clusterconfigsResource = schema.GroupVersionResource{Group: "global.mongodbatlas.kubeform.com", Version: "v1alpha1", Resource: "clusterconfigs"}

var clusterconfigsKind = schema.GroupVersionKind{Group: "global.mongodbatlas.kubeform.com", Version: "v1alpha1", Kind: "ClusterConfig"}
...
func (c *FakeClusterConfigs) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(clusterconfigsResource, c.ns, listOpts)
...
func (c *FakeClusterConfigs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ClusterConfig, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(clusterconfigsResource, c.ns, name, pt, data, subresources...), &v1alpha1.ClusterConfig{})
