...
var endpointservicesResource = schema.GroupVersionResource{Group: "privatelink.mongodbatlas.kubeform.com", Version: "v1alpha1", Resource: "endpointservices"}

var endpointservicesKind = schema.GroupVersionKind{Group: "privatelink.mongodbatlas.kubeform.com", Version: "v1alpha1", Kind: "EndpointService"}
...
func (c *FakeEndpointServices) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.EndpointService, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(endpointservicesResource, c.ns, name), &v1alpha1.EndpointService{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.EndpointService), err
}
...
func (c *FakeEndpointServices) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.EndpointServiceList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(endpointservicesResource, endpointservicesKind, c.ns, opts), &v1alpha1.EndpointServiceList{})
	...
	list := &v1alpha1.EndpointServiceList{ListMeta: obj.(*v1alpha1.EndpointServiceList).ListMeta}
	for _, item := range obj.(*v1alpha1.EndpointServiceList).Items {
...
func (c *FakeEndpointServices) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(endpointservicesResource, c.ns, opts))
...
func (c *FakeEndpointServices) Create(ctx context.Context, endpointService *v1alpha1.EndpointService, opts v1.CreateOptions) (result *v1alpha1.EndpointService, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(endpointservicesResource, c.ns, endpointService), &v1alpha1.EndpointService{})
...
func (c *FakeEndpointServices) Update(ctx context.Context, endpointService *v1alpha1.EndpointService, opts v1.UpdateOptions) (result *v1alpha1.EndpointService, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(endpointservicesResource, c.ns, endpointService), &v1alpha1.EndpointService{})
...
func (c *FakeEndpointServices) UpdateStatus(ctx context.Context, endpointService *v1alpha1.EndpointService, opts v1.UpdateOptions) (*v1alpha1.EndpointService, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(endpointservicesResource, "status", c.ns, endpointService), &v1alpha1.EndpointService{})
...
func (c *FakeEndpointServices) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(endpointservicesResource, c.ns, name), &v1alpha1.EndpointService{})
...
func (c *FakeEndpointServices) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(endpointservicesResource, c.ns, listOpts)

	_, err := c.Fake.Invokes(action, &v1alpha1.EndpointServiceList{})
	return err
}
...
func (c *FakeEndpointServices) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.EndpointService, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(endpointservicesResource, c.ns, name, pt, data, subresources...), &v1alpha1.EndpointService{})
