...
// AuditingV1alpha1Client is used to interact with features provided by the auditing.mongodbatlas.kubeform.com group.
type AuditingV1alpha1Client struct {
	restClient rest.Interface
}

func (c *AuditingV1alpha1Client) Auditings(namespace string) AuditingInterface {
	return newAuditings(c, namespace)
}
