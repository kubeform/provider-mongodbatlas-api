...
// BackupSnapshotExportJobsGetter has a method to return a BackupSnapshotExportJobInterface.
...
// backupSnapshotExportJobs implements BackupSnapshotExportJobInterface
type backupSnapshotExportJobs struct {
	client rest.Interface
	ns     string
}

// newBackupSnapshotExportJobs returns a BackupSnapshotExportJobs
func newBackupSnapshotExportJobs(c *CloudV1alpha1Client, namespace string) *backupSnapshotExportJobs {
	return &backupSnapshotExportJobs{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *backupSnapshotExportJobs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.BackupSnapshotExportJob, err error) {
	result = &v1alpha1.BackupSnapshotExportJob{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *backupSnapshotExportJobs) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.BackupSnapshotExportJobList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.BackupSnapshotExportJobList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("backupsnapshotexportjobs").
...
func (c *backupSnapshotExportJobs) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *backupSnapshotExportJobs) Create(ctx context.Context, backupSnapshotExportJob *v1alpha1.BackupSnapshotExportJob, opts v1.CreateOptions) (result *v1alpha1.BackupSnapshotExportJob, err error) {
	result = &v1alpha1.BackupSnapshotExportJob{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("backupsnapshotexportjobs").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(backupSnapshotExportJob).
		Do(ctx).
		Into(result)
	return
}
...
func (c *backupSnapshotExportJobs) Update(ctx context.Context, backupSnapshotExportJob *v1alpha1.BackupSnapshotExportJob, opts v1.UpdateOptions) (result *v1alpha1.BackupSnapshotExportJob, err error) {
	result = &v1alpha1.BackupSnapshotExportJob{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("backupsnapshotexportjobs").
		Name(backupSnapshotExportJob.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(backupSnapshotExportJob).
		Do(ctx).
		Into(result)
...
func (c *backupSnapshotExportJobs) UpdateStatus(ctx context.Context, backupSnapshotExportJob *v1alpha1.BackupSnapshotExportJob, opts v1.UpdateOptions) (result *v1alpha1.BackupSnapshotExportJob, err error) {
	result = &v1alpha1.BackupSnapshotExportJob{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("backupsnapshotexportjobs").
...
func (c *backupSnapshotExportJobs) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *backupSnapshotExportJobs) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *backupSnapshotExportJobs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.BackupSnapshotExportJob, err error) {
	result = &v1alpha1.BackupSnapshotExportJob{}
