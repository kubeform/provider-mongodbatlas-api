...
// SearchV1alpha1Client is used to interact with features provided by the search.mongodbatlas.kubeform.com group.
type SearchV1alpha1Client struct {
	restClient rest.Interface
}

func (c *SearchV1alpha1Client) Indexes(namespace string) IndexInterface {
