...
// DataV1alpha1Client is used to interact with features provided by the data.mongodbatlas.kubeform.com group.
type DataV1alpha1Client struct {
	restClient rest.Interface
}

func (c *DataV1alpha1Client) Lakes(namespace string) LakeInterface {
	return newLakes(c, namespace)
}
