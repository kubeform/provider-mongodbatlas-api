...
// PrivateV1alpha1Client is used to interact with features provided by the private.mongodbatlas.kubeform.com group.
type PrivateV1alpha1Client struct {
	restClient rest.Interface
}

func (c *PrivateV1alpha1Client) IpModes(namespace string) IpModeInterface {
	return newIpModes(c, namespace)
}
