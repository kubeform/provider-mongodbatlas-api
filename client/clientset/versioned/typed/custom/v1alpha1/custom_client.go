...
type CustomV1alpha1Interface interface {
	...
	DbRolesGetter
	DnsConfigurationClusterAwsesGetter
}

// CustomV1alpha1Client is used to interact with features provided by the custom.mongodbatlas.kubeform.com group.
type CustomV1alpha1Client struct {
	restClient rest.Interface
}

func (c *CustomV1alpha1Client) DbRoles(namespace string) DbRoleInterface {
	return newDbRoles(c, namespace)
}

func (c *CustomV1alpha1Client) DnsConfigurationClusterAwses(namespace string) DnsConfigurationClusterAwsInterface {
	return newDnsConfigurationClusterAwses(c, namespace)
}
