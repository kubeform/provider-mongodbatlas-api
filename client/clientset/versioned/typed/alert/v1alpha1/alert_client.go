...
// AlertV1alpha1Client is used to interact with features provided by the alert.mongodbatlas.kubeform.com group.
type AlertV1alpha1Client struct {
	restClient rest.Interface
}

func (c *AlertV1alpha1Client) Configurations(namespace string) ConfigurationInterface {
