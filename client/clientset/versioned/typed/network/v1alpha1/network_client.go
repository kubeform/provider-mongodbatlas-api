...
// NetworkV1alpha1Client is used to interact with features provided by the network.mongodbatlas.kubeform.com group.
type NetworkV1alpha1Client struct {
	restClient rest.Interface
}

func (c *NetworkV1alpha1Client) Containers(namespace string) ContainerInterface {
	return newContainers(c, namespace)
}

func (c *NetworkV1alpha1Client) Peerings(namespace string) PeeringInterface {
	return newPeerings(c, namespace)
}
